...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/pefish/clash/constant.Version=$(VERSION)" \
		-X "github.com/pefish/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
