...
You can download Clash core binaries here: [https://github.com/pefish/clash/releases](https://github.com/pefish/clash/releases)
...
```shell
$ go install github.com/pefish/clash@latest
go: downloading github.com/pefish/clash v1.15.1
```
...
```shell
$ git clone --depth 1 https://github.com/pefish/clash
Cloning into 'clash'...
...
GOARCH=arm64 GOOS=darwin CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/pefish/clash/constant.Version=unknown version" -X "github.com/pefish/clash/constant.BuildTime=Mon May  8 16:47:10 UTC 2023" -w -s -buildid=' -o bin/clash-darwin-arm64
$ file bin/clash-darwin-arm64
bin/clash-darwin-arm64: Mach-O 64-bit executable arm64
```

For other build targets, check out the [Makefile](https://github.com/pefish/clash/blob/master/Makefile).
